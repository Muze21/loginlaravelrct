...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // TAMBAHIN INI - Kirim data ke Laravel API
      const response = await authAPI.register({
        name: name,
        email: email,
        password: password,
        password_confirmation: password,
        //role: role  // Tambah field role buat database
      });
      ...
      // DEBUG: Log buat cek data
      console.log('✅ USER CREATED:', response.data);
      
      toast.success("Registrasi berhasil! Akun telah dibuat.");
      navigate("/");
